  ...
  return (
    <nav 
      className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 ${
        isScrolled || isMenuOpen ? "py-5 bg-brand-bg/95 backdrop-blur-2xl border-b border-white/[0.05]" : "py-8 bg-transparent"
      }`}
    >
      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            ...
            <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-brand-accent-light/5 blur-[100px] rounded-full pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[200px] h-[200px] bg-brand-accent-light/5 blur-[80px] rounded-full pointer-events-none" />
